...
import { ChevronDown, Play, Pause, Sparkles, Heart } from "lucide-react"
...
export function VipHero() {
  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Overlay celestial con nubes */}
      <div className="absolute inset-0 bg-gradient-to-b from-sky-100/30 via-white/10 to-pink-100/20 z-1"></div>
        ...
        >
          ...
          >
            <p className="text-white text-lg md:text-xl font-light tracking-wide leading-relaxed">
              Un día bendecido lleno de amor y bendiciones celestiales
            </p>
          ...
          >
            <p className="text-sm md:text-base text-pink-200 opacity-90">
              Hija de {vipDemoData.event.parents.father}
            </p>
            <p className="text-sm md:text-base text-pink-200 opacity-90">
              y {vipDemoData.event.parents.mother}
            </p>
            <div className="mt-3 pt-3 border-t border-sky-300/30">
              <p className="text-xs md:text-sm text-sky-300 opacity-80">
                Padrinos: {vipDemoData.event.godparents.godfather} y {vipDemoData.event.godparents.godmother}
              </p>
            </div>
          </motion.div>
        </motion.div>
