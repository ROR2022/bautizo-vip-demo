...
export function BasicCountdown() {
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(135, 206, 235, 0.7), rgba(255, 192, 203, 0.7)), url('${basicDemoData.countdown.backgroundImage}')`,
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundAttachment: 'fixed'
      }}
    >
      {/* Decoración de nubes flotantes */}
      ...
      <div className="max-w-4xl mx-auto text-center text-white relative z-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl opacity-90">
            Sacramento de Bautismo de Sofia Valentina
          </p>
        </div>
